if (!customElements.get('localization-form')) {
  customElements.define(
    ...
    class LocalizationForm extends HTMLElement {
      ...
      openSelector() {
        const isMobileHeaderInline = !!this.closest('.nav-mobile-localization');
        if (isMobileHeaderInline) {
          const scopedForms = this.closest('.nav-mobile-localization').querySelectorAll('localization-form');
          scopedForms.forEach((formEl) => {
            if (formEl !== this && typeof formEl.hidePanel === 'function') formEl.hidePanel();
          });
        }
        this.elements.button.focus();
        ...
        if (!isMobileHeaderInline && !document.body.classList.contains('overflow-hidden-tablet')) {
