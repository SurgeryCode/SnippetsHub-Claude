...
class CartItems extends HTMLElement {
  ...
  getSectionsToRender() {
    ...
    const itemsSection = document.getElementById('main-cart-items');
    if (itemsSection) {
      sections.push({
        id: 'main-cart-items',
        section: itemsSection.dataset.id,
    ...
    const footerSection = document.getElementById('main-cart-footer');
    if (footerSection) {
      sections.push({
        id: 'main-cart-footer',
        section: footerSection.dataset.id,
        selector: '.js-contents',
      });
    }
        ...
        CartPerformance.measure(`${eventTarget}:paint-updated-sections`, () => {
          ...
          this.getSectionsToRender().forEach((section) => {
            try {
              ...
              const sectionSelector = section.selector || '.js-contents';
              const elementToReplace = container.querySelector(sectionSelector) || container;
  ...
  getSectionInnerHTML(html, selector) {
    ...
    // Fallback: if it's a snippet based section, it won't have the selector inside the response
