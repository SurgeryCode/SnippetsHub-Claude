...
$(document).ready(function () { 
    ...
    function checkFirstStep() {
        ...
        //         input.addClass("is-invalid");
        //     }
        //     console.log("validCartPersonEmail: " + validCompanyNip);
        // });

        $('#cartPersonEmail').blur(function() {
            var input = $(this);
            var emailPattern = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
            var is_email = emailPattern.test(input.val());
            if(is_email){
            ...
            console.log("validCartPersonEmail: " + validCompanyNip + " this val");
        }).blur();
    ...
    function checkPersonData(){
        ...
        checkCartPersonIsValid.each(function(){
            ...
            } else if($(this).attr("id") == "#cartFormCompanyNip" || $(this).attr("id") == "cartFormNumber" || $(this).attr("id") == "cartFormNumberShipping"){
