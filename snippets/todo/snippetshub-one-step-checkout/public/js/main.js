...
$(document).ready(function () { 
    ...
    $(customeControlCustomRadioDeliveryPay).click(function() {
        if ($("#checkFormDeliveryUps").is(":checked")) {      
            ...
            $("#checkFormPayReceipt").prop("checked", false);
        }       
    });
    ...
    function checkFirstStep() {
        ...
        var isValid = false;
        var validFormDifferentAddress = validCartFormNameShipping && validCartFormLastNameShipping && validCartFormNumberShipping &&  validCartFormAddressShipping && validCartFormAddressCityShipping && validCartFormAddressZipShipping ? true : false;
        var validFormPerson = validCartPersonEmail && validCartFormName && validCartFormLastName && validCartFormNumber && validCartFormAddress && validCartFormAddressCity && validCartFormAddressZip ? true : false;

        if(validFormPerson) {
            isValid = true;
        } 
        else if($("#cartFormDifferentShippingAddress").is(":checked") && validFormDifferentAddress) {
            isValid = true;
        } else if ($("#checkFormTypeBusiness").is(":checked") && validCompanyNip) {
            isValid = true;
        }
        else {
            validFormPerson = false;
            validFormDifferentAddress = false;
            isValid = false;
        }

        console.log("validCompanyNip: " + validCompanyNip);
        console.log("validFormPerson: " + validFormPerson);
        console.log("validFormDifferentAddress: " + validFormDifferentAddress);
